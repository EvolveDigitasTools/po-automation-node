  ...
  return (
    <div>
      ...
      <div className="sampleDownload">
        <h2>Add New SKUs</h2>
        <button className="downloadSheet" onClick={() => window.location.href="/download-sample-sku"}>
      ...
      <form id="skuForm">
        ...
        <button type="button" onClick={uploadFile}>Upload & Preview</button>
      </form>
      ...
      <button className="submitBtn" onClick={submitSkus}>Submit</button>
    </div>
  );
};
